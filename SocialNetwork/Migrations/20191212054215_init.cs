        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobileNumberConfirmed = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiresTime = table.Column<DateTimeOffset>(nullable: false),
                    LastLoginTime = table.Column<DateTimeOffset>(nullable: false),
                    LastLoginIp = table.Column<string>(nullable: true),
                    LastLoginUserAgent = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccessTokens_Accounts_UserId",
                        column: x => x.UserId,
